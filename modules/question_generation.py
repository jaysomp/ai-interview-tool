...
from modules.serper_search import serper_search

load_dotenv()  
client = genai.Client() 

def generate_interview_questions(job_title: str, job_description: str, company_name: str, num_questions: int = 5) -> list[str]:
    """
    ...
    search_results = serper_search(company_name, job_title)
